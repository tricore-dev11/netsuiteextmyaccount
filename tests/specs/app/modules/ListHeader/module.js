define(['ListHeader'],function (ListHeader)
{
	'use strict';
	...
	return describe('List Header', function ()
	{
		...
		describe('updateCollection', function ()
		{
			...
			it('should call colleciton update when the selected current filters', function ()
			{
		...
		describe('getFilterFromUrl', function ()
		{
			...
			it('in case getFilter returns truthy should return it', function ()
			{
				...
				list_header.getFilter = jasmine.createSpy('fake getFilter').andCallFake(function ()
				{
			...
			{
				var expected_result = 'my result';
				list_header.getDefaultFilter = jasmine.createSpy('fake getDefaultFilter').andCallFake(function()
				{
					return expected_result;
				});
				list_header.getFilter = jasmine.createSpy('fake getFilter').andCallFake(function ()
		...
		describe('getDisplayFromUrl', function ()
		{
			...
			{
				var expected_result = 'my result';
				list_header.getDisplay = jasmine.createSpy('fake getDisplay').andCallFake(function ()
				{
					return expected_result;
				});
			...
			{
				var expected_result = 'my result';
				list_header.getDefaultDisplay = jasmine.createSpy('fake getDefaultDisplay').andCallFake(function()
				{
					return expected_result;
				});
				list_header.getDisplay = jasmine.createSpy('fake getDisplay').andCallFake(function ()
		...
		describe('getSortFromUrl', function ()
		{
			...
			{
				var expected_result = 'my result';
				list_header.getSort = jasmine.createSpy('fake getSort').andCallFake(function ()
				{
					return expected_result;
				});
			...
			{
				var expected_result = 'my result';
				list_header.getDefaultSort = jasmine.createSpy('fake getDefaultSort').andCallFake(function()
				{
					return expected_result;
				});
				list_header.getSort = jasmine.createSpy('fake getSort').andCallFake(function ()
		...
		describe('filterHandler', function ()
		{
			it('should call unselectAll, updateUrl and set selectedFilter', function ()
			{
				...
				list_header.updateUrl = jasmine.createSpy('fake updateUrl').andCallFake(function ()
				{
					return list_header;
				});
				list_header.getFilter = jasmine.createSpy('fake getFilter').andCallFake(function ()
