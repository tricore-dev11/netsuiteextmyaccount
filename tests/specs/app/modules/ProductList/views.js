...
define(
['ProductListDetails.View', 'ProductListControl.Views', 'ProductList.Collection', 'ProductList.Model', 'ItemDetails.Model', 'ItemDetails.Collection', 'Application'], 
function (ProductListDetailsView, ProductListControlViews, ProductListCollection, ProductListModel, ItemDetailsModel)
{
	'use strict';
	...
	describe('ProductListDetails.View', function ()
	{
		...
		it('deleteListItem: delete an item from a list', function ()
		{
			...
			view.deleteListItem(product_list_item);
	...
	describe('ProductListControl.Views', function ()
	{
		...
		xit('should show correct amount of lists', function()
		{ 
