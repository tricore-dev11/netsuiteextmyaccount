SC.Translations={
	...
	"Company Name is required": "Attention is required",
	...
	"Full Name": "Addressee - Full Name",
	"Full Name is required": "Addressee - Full Name is required",
	"Home": "Home",
	"Image": "Image",
	"In Stock": "In Stock",
	...
	"Zip Code": "Zip",
	"Zip Code is required": "Zip is required",
	"#$(0)": "#$(0)",
	"$(0)": "$(0)",
...
"Show Return Authoziations":"Show Return Authoziations", 
"Show all statuses":"Show all statuses", 
...
" Sorry, the information you provided is either incomplete or needs to be corrected.":" Sorry, the information you provided is either incomplete or needs to be corrected.", 
"$(0) is required":"$(0) is required", 
"$(0) items successfully added to <a href=\"#\" data-touchpoint=\"viewcart\">your cart</a></br>":"$(0) items successfully added to <a href=\"#\" data-touchpoint=\"viewcart\">your cart</a></br>", 
"$(0) must be at most $(1) characters":"$(0) must be at most $(1) characters", 
"$(0) packages to track":"$(0) packages to track", 
...
"<span class=\"billaddress-drop-down\">Billing address</span>":"<span class=\"billaddress-drop-down\">Billing address</span>", 
"<span class=\"items-drop-down\">Returns ($(0))</span>":"<span class=\"items-drop-down\">Returns ($(0))</span>", 
"<span class=\"payment-information-drop-down\">Payment Information</span>":"<span class=\"payment-information-drop-down\">Payment Information</span>", 
"<span class=\"text-light\">Quantity</span>: <span class=\"item-quantity\">$(0) of $(1)</span>":"<span class=\"text-light\">Quantity</span>: <span class=\"item-quantity\">$(0) of $(1)</span>", 
"<span class=\"text-light\">Quantity</span>: <span class=\"item-quantity\">$(0)</span>":"<span class=\"text-light\">Quantity</span>: <span class=\"item-quantity\">$(0)</span>", 
"<span class=\"text-light\">SKU</span>: #<span class=\"item-sku\">$(0)</span>":"<span class=\"text-light\">SKU</span>: #<span class=\"item-sku\">$(0)</span>", 
"<span class=\"text-light\">SKU</span>: <span class=\"item-sku\">#$(0)</span>":"<span class=\"text-light\">SKU</span>: <span class=\"item-sku\">#$(0)</span>", 
"<span class=\"visible-phone text-light\">Amount:</span> <span class=\"item-amount\">$(0)</span>":"<span class=\"visible-phone text-light\">Amount:</span> <span class=\"item-amount\">$(0)</span>", 
"<span class=\"visible-phone text-light\">Amount</span> <span class=\"item-amount\">$(0)</span>":"<span class=\"visible-phone text-light\">Amount</span> <span class=\"item-amount\">$(0)</span>", 
"<span class=\"visible-phone text-light\">Quantity:</span> <span class=\"item-quantity\">$(0)</span>":"<span class=\"visible-phone text-light\">Quantity:</span> <span class=\"item-quantity\">$(0)</span>", 
"<span class=\"visible-phone text-light\">Quantity</span> <span class=\"item-quantity\">$(0)</span>":"<span class=\"visible-phone text-light\">Quantity</span> <span class=\"item-quantity\">$(0)</span>", 
"<span class=\"visible-phone text-light\">Reason:</span> <span class=\"item-reason\">$(0)</span>":"<span class=\"visible-phone text-light\">Reason:</span> <span class=\"item-reason\">$(0)</span>", 
"<span class=\"visible-phone text-light\">Unit price:</span> <span class=\"item-price\">$(0)</span>":"<span class=\"visible-phone text-light\">Unit price:</span> <span class=\"item-price\">$(0)</span>", 
"<span class=\"visible-phone text-light\">Unit price</span> <span class=\"item-reason\">$(0)</span>":"<span class=\"visible-phone text-light\">Unit price</span> <span class=\"item-reason\">$(0)</span>", 
"<span class=\"visible-phone\">Remaining Amount: </span><span class=\"creditmemo-remaining\">$(0)</span>":"<span class=\"visible-phone\">Remaining Amount: </span><span class=\"creditmemo-remaining\">$(0)</span>", 
...
"Amount: ":"Amount: ", 
"Amount: <span class=\"amount strong\">$(0)</span>":"Amount: <span class=\"amount strong\">$(0)</span>", 
"Amount: <span class=\"amount\">$(0)</span>":"Amount: <span class=\"amount\">$(0)</span>", 
"Amount: <span class=\"total-formatted\">$(0)</span>":"Amount: <span class=\"total-formatted\">$(0)</span>", 
"Amount: <span>$(0)</span>":"Amount: <span>$(0)</span>", 
...
"Create a New List":"Create a New List", 
"Create and Move Item":"Create and Move Item", 
"Creation date: <span class=\"creation-date\">$(0)</span>":"Creation date: <span class=\"creation-date\">$(0)</span>", 
...
"Deposits (<span class=\"deposits-count\">$(0)</span>)":"Deposits (<span class=\"deposits-count\">$(0)</span>)", 
"Due Date: <span class=\"due-date\">$(0)</span>":"Due Date: <span class=\"due-date\">$(0)</span>", 
"Due date: ":"Due date: ", 
"Edit List":"Edit List", 
"Email/Share List":"Email/Share List", 
"Error":"Error", 
"Expiration date: ":"Expiration date: ", 
"Expiration date: <span class=\"date-closeoverdue\">$(0)</span>":"Expiration date: <span class=\"date-closeoverdue\">$(0)</span>", 
"Expiration date: <span class=\"date-due\">$(0)</span>":"Expiration date: <span class=\"date-due\">$(0)</span>", 
"Expiration date: <span class=\"date-overdue\">$(0)</span>":"Expiration date: <span class=\"date-overdue\">$(0)</span>", 
"Expiration date: Not specified":"Expiration date: Not specified", 
"Expires <span class=\"credit-card-expiredate\">$(0)</span>":"Expires <span class=\"credit-card-expiredate\">$(0)</span>", 
"Filter":"Filter", 
...
"Good! Your $(0) list was successfully created. ":"Good! Your $(0) list was successfully created. ", 
"Good! Your $(0) list was successfully updated. ":"Good! Your $(0) list was successfully updated. ", 
"Invoice Date: <span class=\"date\">$(0)</span>":"Invoice Date: <span class=\"date\">$(0)</span>", 
"Invoice: <a href=\"$(1)\">#$(0)</a>":"Invoice: <a href=\"$(1)\">#$(0)</a>", 
"Invoices ($(0))":"Invoices ($(0))", 
"Invoices (<span class=\"invoices-count\">$(0)</span>)":"Invoices (<span class=\"invoices-count\">$(0)</span>)", 
"Items subtotal":"Items subtotal", 
"Last message: <span class=\"last-message-date\">$(0)</span>":"Last message: <span class=\"last-message-date\">$(0)</span>", 
"Loading":"Loading", 
"Loading List...":"Loading List...", 
"Loading Lists...":"Loading Lists...", 
"No Payment Due":"No Payment Due", 
"No order were found":"No order were found", 
...
"Product pending shipment ($(0))":"Product pending shipment ($(0))", 
"Product shipped ($(0))":"Product shipped ($(0))", 
"Product that doesn't require shipping ($(0))":"Product that doesn't require shipping ($(0))", 
"Products":"Products", 
"Products ($(0))":"Products ($(0))", 
"Products (<span class=\"items-count\">$(0)</span>)":"Products (<span class=\"items-count\">$(0)</span>)", 
"Products from original order not eligible for return ($(0))":"Products from original order not eligible for return ($(0))", 
"Products pending shipment ($(0))":"Products pending shipment ($(0))", 
"Products shipped ($(0))":"Products shipped ($(0))", 
"Products that don't require shipping ($(0))":"Products that don't require shipping ($(0))", 
"Quantity to return:":"Quantity to return:", 
"Quantity:":"Quantity:", 
"Receipt <b class=\"tranid\">#$(0)</b>":"Receipt <b class=\"tranid\">#$(0)</b>", 
"Remaining Amount: ":"Remaining Amount: ", 
"Remove Items":"Remove Items", 
"Reply with a message:":"Reply with a message:", 
"Request a Return":"Request a Return", 
"Request date: <span class=\"date\">$(0)</span>":"Request date: <span class=\"date\">$(0)</span>", 
"Requested from":"Requested from", 
"Return Products":"Return Products", 
"Return authorization: <a href=\"returns/$(1)\">#$(0)</a>":"Return authorization: <a href=\"returns/$(1)\">#$(0)</a>", 
"Return request <span class=\"strong-text return-number\">#$(0)</span>":"Return request <span class=\"strong-text return-number\">#$(0)</span>", 
"Returned Product (<span class=\"items-count\">$(0)</span>)":"Returned Product (<span class=\"items-count\">$(0)</span>)", 
"Returned Products (<span class=\"items-count\">$(0)</span>)":"Returned Products (<span class=\"items-count\">$(0)</span>)", 
"Same as Address":"Same as Address", 
...
"The quantity of some of the items needs to be updated to match the minimum required to purchase. Go to $(0)":"The quantity of some of the items needs to be updated to match the minimum required to purchase. Go to $(0)", 
"The selected items were removed from your product list":"The selected items were removed from your product list", 
"Total Amount":"Total Amount", 
"Transaction Date: <span class=\"transaction-date\">$(0)</span>":"Transaction Date: <span class=\"transaction-date\">$(0)</span>", 
"Type of inquiry: <span class=\"type\">$(0)</span>":"Type of inquiry: <span class=\"type\">$(0)</span>", 
"Unit price":"Unit price", 
"Use this Address":"Use this Address", 
